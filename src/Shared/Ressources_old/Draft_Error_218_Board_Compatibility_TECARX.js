...
type:'list',
indentation:'18',
data:'2. Even if the TECARX is disconnected and connected to the generic cable, the error will occur again.',
},
{
type:'list',
indentation:'18',
data:'3. The TECARX is unusable, and the problem can’t be fixed remotely.',
},
{
type:'list',
indentation:'18',
data:'4. The TECARX must be sent to WINBACK after-sales service.',
},
{
type:'title',
data:'Repair',
